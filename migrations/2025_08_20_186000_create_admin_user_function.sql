-- Insert first admin user for testing
-- Note: This user will need to sign up through the auth system first
-- This is just a placeholder to show the structure

-- Function to create admin user (for testing purposes)
